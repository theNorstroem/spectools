...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.792ed546855cf905a62219fd88f204072be8db0312b32184fe51279030347c8d.js',function(){input.required=false;search();});}

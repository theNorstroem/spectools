...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.259ef760386fb8dbb5a7eb89a6fdae545074b552ea1483d1225c0782e1eabb59.js',function(){input.required=false;search();});}

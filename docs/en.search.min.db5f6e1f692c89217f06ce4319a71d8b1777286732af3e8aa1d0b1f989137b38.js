...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.40af0f1d5c1313dcd7e89272cb9760f8216a679f7f633234752c0a3eca2fd5cb.js',function(){input.required=false;search();});}

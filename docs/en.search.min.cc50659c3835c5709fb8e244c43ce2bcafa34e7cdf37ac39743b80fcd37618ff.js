...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.1a18d2e5b74f6f5c3b72856a348fe7b1ae6cdeaaf772113cad7ea1191df8ce17.js',function(){input.required=false;search();});}
